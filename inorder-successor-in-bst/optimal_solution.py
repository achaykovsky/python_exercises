...
class BinarySearchTree:
    ...
    def find_in_order_successor(self, inputNode):
        successor = None
        if inputNode.right:  # If the inputNode has a right child,
            # the successor is the leftmost node in the right subtree
            successor = inputNode.right
            inputNode = inputNode.right
            while successor.left:
                successor = inputNode.left
                inputNode = inputNode.left
        else:  # If the inputNode has no right child, the successor is one of its ancestors.
            # Traverse up the tree until you find a node that is the left child of its parent.
            # The parent of that node is the successor.
            while inputNode.parent and inputNode.key > inputNode.parent.key:
